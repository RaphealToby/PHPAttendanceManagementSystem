...
<header>
  ...
  <h1>Laspotech Attendance Management System</h1>
</header>
			...
			<div class="col-sm-7">
			  <label>
			    <input type="radio" name="type" id="optionsRadios1" value="student" checked> Student			  </label>
			  	  <label>
			    <input type="radio" name="type" id="optionsRadios1" value="teacher"> Teacher			  </label>
			  <label>
			    <input type="radio" name="type" id="optionsRadios1" value="admin"> Admin			  </label>
			</div>
			</div>
...
<p>&nbsp;</p>
<p><strong>Proudly Developed by: <span class="style1">Group A </span></strong></p>
	</center>
</body>
</html>